...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            <head>
                <title>Galeria de Produtos - Tablet</title>
                <style>
                    ul {
            ...
            <body>
                <ul>
                    ...
                    <li><a class="active" href="notebook.xml">Tablet</a></li>
                </ul>
                <div class="row">
                    <xsl:for-each select="produtos/produto [tipo = 'tablet']">
